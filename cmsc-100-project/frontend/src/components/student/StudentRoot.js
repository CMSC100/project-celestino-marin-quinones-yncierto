        ...
        <ColorModeContext.Provider value={colorMode}>
            <ThemeProvider theme={theme}>
                ...
                <div className={`body ${showSuccessMessage ? "overlay-visible" : ""}`}>
                    <div className='main-content' style={{backgroundColor: theme.palette.mode === 'dark' ? colors.primary[500] : '#f5f4f7'}}>
                        <StudentSideBar setProfileModalOpen={setProfileModalOpen} />
                        <Outlet context={[triggerFetchApp, setTriggerFetchApp]}/>
                    </div>
                    {profileModalOpen && <StudentProfile setProfileModalOpen={setProfileModalOpen} userData={userData}/>}
                    {showSuccessMessage && (
                    <div className="popup">
